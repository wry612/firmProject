            ...
            getTicks: function () {
                ...
                if (interval) {
                    ...
                    while (ticks.length<3) {
                        ...
                        roundingErrorFix(mid, precision);
...
define('echarts/chart/helper/whiskerBoxCommon', ['require', '../../data/List', '../../data/helper/completeDimensions', '../helper/WhiskerBoxDraw', 'zrender/core/util'], function (require) {
    'use strict';
...
define('echarts/coord/axisHelper', ['require', '../scale/Ordinal', '../scale/Interval', '../scale/Time', '../scale/Log', '../scale/Scale', '../util/number', 'zrender/core/util', 'zrender/contain/text'], function (require) {
    ...
    axisHelper.getFormattedLabels = function (axis, labelFormatter) {
        ...
        if (typeof labelFormatter === 'string') {
            ...
            return zrUtil.map(ticks, function (tick, idx,ticks) {
                return labelFormatter(axis.type === 'category' ? scale.getLabel(tick) : tick, idx,ticks);
            }, this);
        } else {
            return labels;
        }
